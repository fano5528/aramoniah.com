    ...
    return (
        <>
            ...
            <div className="mt-0 block md:flex justify-between mt-16 sm:mt-24 mb-24 w-complete sm:w-complete-sm mx-auto">
                ...
                <p className="md:w-96 text-gris mt-6 md:mt-0">Cada curso y taller está enfocado al empoderamiento personal, buscando conectar con nosotros de manera real, genuina y desde la aceptación, usando el poder de nuestra historia a nuestro favor.</p>
            </div>
