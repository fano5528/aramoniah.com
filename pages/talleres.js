        ...
        <>
            ...
            <div className="w-complete sm:w-complete-sm mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-x-20 md:gap-y-12 md:grid-rows-[auto_auto_autopx]">
                ...
                <Parallax speed={6} className="h-full w-full md:row-start-2 md:row-end-4">
                    <div className="shadow-lg bg-[#e0e0e0] h-[500px] md:h-[calc(100%-44px)] w-full bg-center bg-cover opacity-90" style={{backgroundImage: "url('https://internaut.nyc3.cdn.digitaloceanspaces.com/aramoniah.com/escritura.jpg')"}}></div>
