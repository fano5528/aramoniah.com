...
export default function Ceremonias() {
    return (
        <>
            ...
            <div className="w-complete sm:w-complete-sm mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-x-20 md:gap-y-12 md:grid-rows-[auto_auto_autopx]">
                <Parallax speed={5} className="h-[500px] w-full md:row-start-1 md:row-end-3">
                    <div className="shadow-lg bg-[#e0e0e0] h-96 md:h-[calc(100%-44px)] w-full bg-center bg-cover opacity-90" style={{backgroundImage: "url('/empoderamiento.jpg')"}}></div>
                    <h1 className="mt-4 font-serif text-xl text-gris">Empoderamiento a través del ser</h1>
                </Parallax>
                <Parallax speed={2} className="h-[400px] w-full md:row-start-1 md:row-end-2">
                    <div className="shadow-lg bg-[#e0e0e0] h-96 md:h-[calc(100%-44px)] w-full bg-center bg-cover opacity-90" style={{backgroundImage: "url('/historia.jpg')"}}></div>
                    <h1 className="mt-4 font-serif text-xl text-gris">El poder de tu historia</h1>
                </Parallax>
                <Parallax speed={3.5} className="h-[400px] w-full md:row-start-3 md:row-end-4">
                    <div className="shadow-lg bg-[#e0e0e0] h-96 md:h-[calc(100%-44px)] w-full bg-center bg-cover opacity-90" style={{backgroundImage: "url('/meditacion.jpg')"}}></div>
                ...
                <Parallax speed={6} className="h-full w-full md:row-start-2 md:row-end-4">
                    <div className="shadow-lg bg-[#e0e0e0] h-[500px] md:h-[calc(100%-44px)] w-full bg-center bg-cover opacity-90" style={{backgroundImage: "url('/escritura.jpg')"}}></div>
