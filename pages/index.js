...
export default function Home() {
  return (
    ...
    <div className="w-complete sm:w-complete-sm mt-20 sm:mt-28 mx-auto md:grid md:grid-cols-2 gap-12">
      ...
      <div style={{backgroundImage: "url('https://internaut.nyc3.cdn.digitaloceanspaces.com/aramoniah.com/ad2.jpg');"}} className="md:order-1 mt-8 md:mt-0 w-full h-80 sm:h-[400px] bg-cover bg-center opacity-90">
