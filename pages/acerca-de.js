...
Pero cuando las cosas se acomodan y llega tu momento es que la vida fluye y te pone justo en el lugar indicado.</p>
            ...
            <div className="bg-cover bg-center h-96 md:col-start-1 md:col-end-3 shadow-fanoespecial" style={{backgroundImage: "url('https://internaut.nyc3.cdn.digitaloceanspaces.com/aramoniah.com/birthday.jpg')"}}></div>
            <div className="shadow-fanoespecial bg-white px-14 py-14">
