    ...
    return (
        ...
        <div className="w-complete sm:w-complete-sm grid grid-cols-1 md:grid-cols-2 gap-12 mx-auto mt-20">
            ...
            <div className="shadow-fanoespecial bg-white px-14 py-14">
                ...
                <p className="mt-5 text-gris">Mi nombre es Carmen Aramoni, siempre he sentido una gran fascinación acerca de las conexiones, entender que todos tenemos algo que aportar y aprender de las historias de los demás, ya que al compartir conectamos. 
<br/><br/>
