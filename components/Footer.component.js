...
export default function Footer({props}) {
    return (
        ...
        <footer className="w-full bg-azul text-white flex flex-col justify-center items-start mt-32 py-12 sm:py-12">
            ...
            <div className="mt-8 sm:mt-20 sm:flex sm:justify-between items-end w-complete sm:w-complete-sm mx-auto">
